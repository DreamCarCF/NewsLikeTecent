...
- (void)prepare
{
    ...
    _textInset = 10.0f;
    // 初始化文字字体
    _textFont = [UIFont fontWithName:@"Helvetica-Bold" size:20];
    // 初始化文字普通状态时的颜色
...
//    [self.leftBtn setImage:_leftImage_normal forState:UIControlStateNormal];
    [self.leftBtn setBackgroundImage:_leftImage_normal forState:UIControlStateNormal];
